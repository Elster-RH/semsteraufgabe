...
public class addStudent extends JDialog {
    ...
    public addStudent(JFrame parent, StudentContainer container) {
        ...
        JTextArea hinweisarea = new JTextArea("         Zum Entfernen eines Studenten bitte nur und dessen Email eingeben ");
        JTextArea hinweisarea2 = new JTextArea("denn entsprechenden Button drücken");
